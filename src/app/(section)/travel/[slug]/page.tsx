...
export default async function MusicArticle({params,
}: {
  params: Promise<{ slug: string }>;
}) {
  const { slug } = await params;
   const article = await getArticleBySlug('travel', slug);
   const allArticles = await getArticles("travel");
  ...
  return (
  <>
    <article className="container mx-auto w-full px-4 py-8 mt-15">
      ...
      <div className="mt-20 mb-10 w-full flex flex-col items-start gap-6 border-t border-[#898989]">
